...
export default function MembershipInfo() {
  return (
    <PublicPage>
      <PublicPageLayout title="Membership Information">
        <PublicSection title="Joining the Club">
          <p>
            First time members, please review the{" "}
            <a href="/CRTC_WaitListPolicy.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:cursor-pointer">
              Wait List
            </a>{" "}
            policy.
          </p>
          ...
          <p>
            The indicated rate schedule is applicable to membership applications
            received or postmarked by March 15th, 2026. After that date, fees
            will increase. Half-season memberships, at half-rates, are available
            starting July 15th, but only for applicants who are joining the club
            for the first time.
          </p>
        </PublicSection>

        <PublicSection title="CRTC Leagues">
          <div>
            <p>
          ...
          <div>
            <p>
              ...
              post season playoffs in September-October.
            </p>
            <ul className="mt-2 list-disc pl-10">
